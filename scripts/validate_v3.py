#!/usr/bin/env python3
"""Validate v3 (45K, 142GB) tokenizer."""
import json, random
from pathlib import Path
from tokenizers import Tokenizer

V3 = "/media/data1tb/ezellm-coder-tokenizer/wisetok-production-45k/tokenizer.json"
PYTHON_SHARDS = Path("/media/data1tb/stackv2-dedup-sub/Python/")

print(f"Loading {V3}")
tok = Tokenizer.from_file(V3)
...
print("\n--- Top 20 merges ---")
with open(V3) as f: cfg = json.load(f)
